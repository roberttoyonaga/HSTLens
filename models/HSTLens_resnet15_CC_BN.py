...
class deeplens_classifier(BaseKerasClassifier):
    ...
    def _model_definition(self, net):
        ...
        net = pre_activated_resnet_block(net, n_filters_in=16, n_filters_out=32,  preactivated=False, downsampling=True,)
        net = pre_activated_resnet_block(net, n_filters_in=16, n_filters_out=32,)
        net = pre_activated_resnet_block(net, n_filters_in=16, n_filters_out=32,)
        
        net = pre_activated_resnet_block(net, n_filters_in=32, n_filters_out=64,  preactivated=False, downsampling=True,)
        net = pre_activated_resnet_block(net, n_filters_in=32, n_filters_out=64,)
        net = pre_activated_resnet_block(net, n_filters_in=32, n_filters_out=64,)
        
        net = pre_activated_resnet_block(net, n_filters_in=64, n_filters_out=128,  preactivated=False, downsampling=True,)
        net = pre_activated_resnet_block(net, n_filters_in=64, n_filters_out=128,)
        net = pre_activated_resnet_block(net, n_filters_in=64, n_filters_out=128,)
