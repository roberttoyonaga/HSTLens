...
class BaseKerasClassifier():
    ...
    def _build(self, X, y):
        print ("building resnet6_CC_2_l2")
        ...
        out = Dense(1024, activation='relu', W_regularizer=l2(0.01), activity_regularizer=activity_l2(0.01))(out) 
        out=Dropout(0.50)(out) 
        out = Dense(512, activation='relu', W_regularizer=l2(0.01), activity_regularizer=activity_l2(0.01))(out) 
        out=Dropout(0.40)(out)
        out = Dense(256, activation='relu', W_regularizer=l2(0.01), activity_regularizer=activity_l2(0.01))(out) 
        out=Dropout(0.30)(out) 
        out = Dense(64, activation='relu', W_regularizer=l2(0.01), activity_regularizer=activity_l2(0.01))(out) 
