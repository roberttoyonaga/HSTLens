...
from HSTLens_base_classifier_resnet2 import BaseKerasClassifier
from HSTLens_blocks_resnet2 import pre_activated_resnet_block
...
class deeplens_classifier(BaseKerasClassifier):
    ...
    def _model_definition(self, net):
        ...
        net = pre_activated_resnet_block(net, n_filters_in=256, n_filters_out=128,  preactivated=False,kernel=3)
        net = pre_activated_resnet_block(net, n_filters_in=128, n_filters_out=64, kernel=3)
        net = pre_activated_resnet_block(net, n_filters_in=64, n_filters_out=32, kernel=3)
