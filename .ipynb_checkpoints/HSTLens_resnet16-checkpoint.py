...
from HSTLens_base_classifier_resnet16 import BaseKerasClassifier
from HSTLens_blocks_resnet16 import pre_activated_resnet_block
...
class deeplens_classifier(BaseKerasClassifier):
    ...
    def _model_definition(self, net):
        ...
        net = pre_activated_resnet_block(net, n_filters_in=32, n_filters_out=64, kernel=3, pool=False) #12x12
